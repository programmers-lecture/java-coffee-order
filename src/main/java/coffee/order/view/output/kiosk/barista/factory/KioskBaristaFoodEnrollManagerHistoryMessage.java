...
import static coffee.order.view.output.kiosk.barista.factory.KioskBaristaFoodEnrollManagerMessage.ANNOUNCE_ENROLL_FINISHED;
...
public class KioskBaristaFoodEnrollManagerHistoryMessage {
    ...
    public void printEnrollFinished() {
        print(ANNOUNCE_ENROLL_FINISHED.message + ENTER.unit);
    }
}
