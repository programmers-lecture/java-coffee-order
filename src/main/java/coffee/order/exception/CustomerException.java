...
public enum CustomerException {
    ...
    CUSTOMER_NOT_CORRECT_PHONE_NUMBER_FORM(new IllegalArgumentException("존재할 수 없는 휴대폰 번호입니다.")),
    CUSTOMER_NOT_EXIST_ORDER_FOOD_NUMBER(new IllegalArgumentException("존재하지 않는 주문 상품 번호입니다."));
